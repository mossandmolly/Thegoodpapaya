...
const ITEM_NAMES = [
  ...
  "Long beans","Brinjal long","Spring onion","Arvi","Cherry tomato","Cluster beans"
];
...
methi → Fenugreek, yellow cucumber → Mangalore cucumber, chilli bhaji/big chilli → Chilli bhajji, kundru → Coccinia, pudina → Mint
