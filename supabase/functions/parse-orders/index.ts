...
const ITEM_NAMES = [
  ...
  "Banana leaves","Spinach","Amaranthus","Fenugreek","Mangalore cucumber","Drumstick","Chilli bhajji","Coccinia"
];
...
methi → Fenugreek, yellow cucumber → Mangalore cucumber, chilli bhaji/big chilli → Chilli bhajji, kundru → Coccinia
